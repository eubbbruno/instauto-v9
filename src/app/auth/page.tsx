...
export default function AuthPage() {
  ...
  const signInWithEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Buscar tipo do usuário para redirecionamento
      ...
      // Redirecionamento simples baseado no tipo
      if (profile?.type === 'oficina') {
        // Para oficinas, verificar se tem plano PRO
  ...
  const signUpWithEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        // Redirecionamento direto baseado no tipo
        setTimeout(() => {
          if (userType === 'oficina') {
            router.push('/oficina-basica') // Padrão FREE, pode mudar depois nas configurações
          } else {
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-8 bg-gradient-to-br from-blue-600 to-indigo-800 text-white">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-3xl font-bold">Instauto</h1>
              </div>
              
              <h2 className="text-xl font-semibold mb-4">
                {userType === 'motorista' ? 'Área do Motorista' : 'Área da Oficina'}
              </h2>
                  ...
                  <button
                    ...
                    className={`p-4 rounded-lg border-2 text-sm font-bold transition-all ${
                      userType === 'motorista'
                        ...
                        : 'bg-blue-700/60 border-blue-500 text-blue-200 hover:border-blue-300'
                    }`}
                  >
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-gray-900 bg-white font-medium pr-12"
