          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-8 bg-white">
              ...
              {activeTab === 'login' && (
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                  ...
                  <div className="mt-6 text-center text-sm text-gray-700">
                    Não tem uma conta? {' '}
                    <button onClick={() => setActiveTab('register')} className="text-blue-600 hover:text-blue-800 font-bold">
                      Cadastre-se grátis
                    </button>
                  </div>
                </motion.div>
              ...
              {activeTab === 'register' && (
                <motion.form initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} onSubmit={signUpWithEmail} className="space-y-4">
                  ...
                  <div className="text-center text-sm text-gray-700">
                    Já tem uma conta? {' '}
                    <button type="button" onClick={() => setActiveTab('login')} className="text-blue-600 hover:text-blue-800 font-bold">
                      Faça login
                    </button>
                  </div>
                </motion.form>
              ...
              <div className="mt-8 text-center">
                ...
                <Link href="/auth/oficina" className="text-blue-600 hover:text-blue-800 font-bold">
